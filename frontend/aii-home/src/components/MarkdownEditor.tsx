    ...
    <div className={`border border-blue-100 rounded-2xl bg-white shadow-xl overflow-hidden`}>
      ...
      {preview ? (
        <div className={`${dense ? 'p-3' : 'p-4'}`}>
          <div
            className="prose prose-blue max-w-none bg-white border border-blue-100 p-4 rounded-xl min-h-[100px]"
        ...
        <>
          ...
          <div className={`${dense ? 'p-3' : 'p-4'}`}>
            <textarea
              ...
              className="w-full p-4 rounded-xl bg-white border border-blue-100 text-blue-800 placeholder-blue-400 focus:outline-none focus:ring-2 focus:ring-purple-500/30 resize-none"
              style={{ minHeight: editorMinHeight }}
            />
          </div>
        </>
