    ...
    >
      <motion.div
        ...
        className={`bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 ${
          isFullScreen 
            ? 'w-full h-full rounded-none flex flex-col justify中心 items-center p-8' 
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div className="space-y-3 sm:space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text白色 placeholder白色/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                placeholder="请输入用户名"
                required
              />
            </div>
            ...
            {!isLogin && (
              <div>
                <label htmlFor="email" className="block text-sm sm:text-base font-medium text白色/80 mb-2">
                  邮箱
                </label>
                <input
                  type="email"
                  ...
                  className="w-full px-4 py-3 bg白色/10 border border白色/20 rounded-lg text白色 placeholder白色/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                  placeholder="请输入邮箱地址"
                  required
                />
              </div>
            ...
            <div>
              <label htmlFor="password" className="block text-sm sm:text-base font-medium text白色/80 mb-2">
                密码
              </label>
              <input
                type="password"
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-3 px-6 rounded-lg font-medium text白色 transition-all duration-200 transform hover:scale-105 active:scale-95 ${
              loading
          ...
          >
            {loading ? (
              <div className="flex items-center justify-center space-x-2">
                <svg className="animate-spin h-5 w-5 text白色" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="text-center mt-6 sm:mt-8">
          <button
            ...
            className="text白色/60 hover:text白色/80 transition-colors text-sm sm:text-base"
          >
        ...
        <button
          ...
          className={`absolute text白色/50 hover:text白色/80 transition-colors hover:bg白色/10 rounded-lg ${
