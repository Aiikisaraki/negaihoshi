...
export const interactApi = {
  like: (contentId: number, isPost: boolean) => apiClient.post('/interact/like', { content_id: contentId, is_post: isPost }),
  unlike: (contentId: number, isPost: boolean) => apiClient.delete('/interact/like', { data: { content_id: contentId, is_post: isPost } }),
